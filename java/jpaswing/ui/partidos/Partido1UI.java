...
@Component
public class Partido1UI extends JFrame {
    private static Partido1UI instance;
    ...
    @Autowired
    public Partido1UI(ResultadoRepository resultadoRepository, EstadioRepository estadioRepository){
        this.resultadoRepository = resultadoRepository;
        this.estadioRepository = estadioRepository;
        initComponents();
        instance = this;
    }
    public static Partido1UI getInstance(){return instance;}
    ...
    private void getImages(String rutaRelativa, int width, int height, JLabel label){
        imageIcon = new ImageIcon(Partido1UI.class.getResource(rutaRelativa));
